...
require_once "../../config.php";
	...
	if(empty($birth_date_error) and empty($birth_month_error) and empty ($birth_year_error )){
	if(checkdate($birth_day,$birth_month,$birth_year)){
		$temp_date = new DateTime($birth_year ."-" .$birth_month ."-" .$birth_day);
		$birth_day = $temp_date->format("y-m-d");	
	}     else {
